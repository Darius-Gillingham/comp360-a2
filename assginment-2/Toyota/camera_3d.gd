...
@onready var body: Node3D = target.get_node('Root Scene')
...
@onready var wheel: Sprite2D = $SteeringWheel/JoelWheel
...
func _physics_process(delta: float) -> void:
	if ((Input.is_action_just_pressed("change_pov")) && (GlobalData.selected_car_scene == "res://Toyota/Toyota.tscn")):
